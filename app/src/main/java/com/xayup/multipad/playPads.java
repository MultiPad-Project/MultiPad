...
import com.xayup.multipad.skinthmeAdapter;
...
//	public static List<Integer> ledOcuped;
	...
	public static void end(Activity context) {
		...
		makePads makepad = new makePads(getCurrentPath, R.id.contAllPads, /*MainActivity.height*/ display_height,
		context);
		makepad.makePadInLayout();
		makepad.changeChainPlayable();
		SkinTheme.playBgimg.setImageDrawable(SkinTheme.playBg);
		if(glowEf){
			glows = new makeGlows(context, padWH, glowPadRadius, glowChainRadius, MainActivity.width, MainActivity.height);
			glows.setOnGlows();
		}
		if (progressAutoplay != null) { //nao remova se nao quiser problemas%
			progressAutoplay.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
				@Override
		...
		stopRecAutoplay.setOnClickListener(new Button.OnClickListener(){
			@Override
			public void onClick(View arg0) {
				recAutoplay = false;
				Toast.makeText(context, context.getString(R.string.rec_ap_saving), Toast.LENGTH_SHORT).show();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		playPads.super.onActivityResult(requestCode, resultCode, data);
		if (null != data) {
			...
			case PICK_PHANTOMC_IMG:
				...
				break;
			case PICK_LOGO_IMG:
				((ImageView)playPads.this.findViewById(9).findViewById(R.id.phantom)).setImageBitmap(imgdata);
				break;
			...
			case PICK_LOGO_BG_IMG:
				((ImageView)playPads.this.findViewById(9).findViewById(R.id.pad)).setImageBitmap(imgdata);
				break;
			}
		}
	}
	...
	public void onBackPressed() {
		...
		View alertExit_layout_decoration_item = onExitDialog.findViewById(R.id.alertExit_layer_decoration_item);
		...
		exit_config.setOnClickListener(new Button.OnClickListener() {
			@Override
			public void onClick(View arg0) {
		...
		//old colors
		old_colors.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View arg0) {
				if(oldColors){
					oldColors = false;
		...
		//Botao color_table
		color_table.setOnClickListener(new Button.OnClickListener(){
			@Override
			public void onClick(View arg0) {
				barTitle.setText(getString(R.string.color_table_title));
				...
				color_table_files.setOnItemClickListener(new AdapterView.OnItemClickListener(){
					@Override
					public void onItemClick(AdapterView<?> adapter, View view, int pos, long id){
						custom_color_table = true;
						Readers.getColorTableForCTFile(new File(VariaveisStaticas.COLOR_TABLE_PATCH), pos, !oldColors);
						
					}
				});
				default_color_table.setOnClickListener(new Button.OnClickListener(){
					@Override
					public void onClick(View arg0) {
						custom_color_table = false;
						Toast.makeText(getApplicationContext(), getApplicationContext().getString(R.string.default_color_table), Toast.LENGTH_SHORT).show();
					}
				});
			}
		});
		...
		ui_img_select.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				//	View ui_img_select_page = getLayoutInflater().inflate(R.layout.ui_img_select, null);
				/*Phatom*/onExitDialog.findViewById(R.id.alertExit_phantom_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
										android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
								startActivityForResult(get_image_from_gallery, PICK_PHANTOM_IMG);
							}
						});
				/*Phatom Center*/onExitDialog.findViewById(R.id.alertExit_phantomC_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
				...
				/*Logo*/onExitDialog.findViewById(R.id.alertExit_logo_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
				...
				/*Logo Color*/onExitDialog.findViewById(R.id.alertExit_logo_bg_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
				...
				/*Background*/onExitDialog.findViewById(R.id.alertExit_background_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
				...
				/*Chain*/onExitDialog.findViewById(R.id.alertExit_chain_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
				...
				/*Buttom color*/onExitDialog.findViewById(R.id.alertExit_btn_select)
						.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View arg0) {
								Intent get_image_from_gallery = new Intent(Intent.ACTION_PICK,
		...
		//sound spam
		sound_spam_item.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				if (spamSounds) {
					spamSounds = false;
					...
					spam_alert.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
						@Override
		...
		//hide buttons
		hide_buttoms.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
		...
		//Slide mode
		slide_mode.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				if (slideMode) {
		...
		//record to autoplay
		rec_autoplay.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View arg0) {
				if(recAutoplay){
					recAutoplay = false;
		...
		//Show glow effect
		glowShow.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				if (glowEf) {
					...
					if (glows == null) {
						...
						glows = new makeGlows(playPads.this, padWH, glowPadRadius, glowChainRadius, MainActivity.width, makePads.layoutpads.getLayoutParams().height);
						glows.setOnGlows();
					} else {
						glows.setOnGlows();
					}
		...
		glow_cfg_show.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				...
				if (glowEf)
					if (ifglow_cfg_show) {
						...
						RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
								glow_cfg_window.getLayoutParams().width, glow_cfg_window.getLayoutParams().height);
						...
						glow_cfg_window.findViewById(R.id.glow_cfg_r_minus)
								.setOnClickListener(new Button.OnClickListener() {
									@Override
									public void onClick(View v) {
										radius.setText("" + (Integer.parseInt(radius.getText().toString()) - 1));
									}
								});
						glow_cfg_window.findViewById(R.id.glow_cfg_r_plus)
								.setOnClickListener(new Button.OnClickListener() {
									@Override
									public void onClick(View v) {
										radius.setText("" + (Integer.parseInt(radius.getText().toString()) + 1));
						...
						EditText intensity = glow_cfg_window.findViewById(R.id.glow_config_edit_intensidade);
						intensity.setText("" + glowIntensity);
						glow_cfg_window.findViewById(R.id.glow_cfg_i_minus)
								.setOnClickListener(new Button.OnClickListener() {
									@Override
									public void onClick(View v) {
										intensity.setText(""
												+ BigDecimal.valueOf(Double.parseDouble(intensity.getText().toString()))
														.subtract(BigDecimal.valueOf(0.01)).floatValue());
									}
								});
						glow_cfg_window.findViewById(R.id.glow_cfg_i_plus)
								.setOnClickListener(new Button.OnClickListener() {
									@Override
									public void onClick(View v) {
										if (BigDecimal.valueOf(Double.parseDouble(intensity.getText().toString()))
												.add(BigDecimal.valueOf(0.01)).floatValue() <= 1.0f)
											intensity.setText("" + BigDecimal
													.valueOf(Double.parseDouble(intensity.getText().toString()))
													.add(BigDecimal.valueOf(0.01)).floatValue());
									}
								});
						//widgets
						...
						changeChainGlows = false;
						padOrChain.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener(){
							@Override
							public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
								...
								if(arg1){
									...
									//glowRadius = Integer.parseInt(radius.getText().toString());
								} else {
							...
							public void onClick(View arg0) {
								if (radius.getText().toString().matches("([1-9]|[1-9][0-9]{0,3})")) {
									...
									//	glowIntensity = intensityAlpha;
										...
										Toast.makeText(playPads.this, getString(R.string.invalid_intensity),
												Toast.LENGTH_LONG).show();
									}
								} else {
									Toast.makeText(playPads.this, getString(R.string.invalid_radius), Toast.LENGTH_LONG)
											.show();
								}
							}
						});
		...
		alertExit_layout_decoration_item.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
		...
		decoration_show.setOnCheckedChangeListener(new CheckBox.OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (!arg1) {
					...
					((LinearLayout) findViewById(R.id.layer_decoration_scale_background)).setVisibility(View.GONE);
				} else {
		...
		//Tamanho das pads
		item_customHeight.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v){
				if(layer_decoration){
				...
				layer_size_plus.setOnClickListener(new View.OnClickListener(){
				...
				layer_size_minus.setOnClickListener(new View.OnClickListener(){
				...
				pads_size_plus.setOnClickListener(new View.OnClickListener(){
				...
				pads_size_minus.setOnClickListener(new View.OnClickListener(){
						...
						if(!lw.isEmpty()){
							if(!lh.isEmpty()){
								if(!phw.isEmpty()){
									...
									lh = "0";
									Toast.makeText(playPads.this, "Pads size error", Toast.LENGTH_SHORT).show();
								}
							} else {
								lh = "0";
								Toast.makeText(playPads.this, "Layer height error", Toast.LENGTH_SHORT).show();
							}
						} else {
							lw = "0";
							Toast.makeText(playPads.this, "Layer width error", Toast.LENGTH_SHORT).show();
						}
		...
		led_spam_item.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				if (spamLeds) {
					spamLeds = false;
